                  ...
                  <div class="flex items-center">
                    <div class="ml-2">
                      ...
                      <div class="text-gray-500 text-xs flex">
                        <span class="inline-block">{{$fb->created_at}}</span>
                       
                      </div>
                    </div>
                  </div>
                  <p class="text-gray-800 text-sm mt-2 leading-normal md:leading-relaxed">{{$fb->comment}}</p>
                </div>
              </div>

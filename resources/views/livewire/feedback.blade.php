<div>
    <!-- component -->
<section>
	<div class="bg-slate-400 text-white py-20">
			...
			<div class="flex flex-col w-full lg:w-2/3 justify-center">
				<div class="container w-full px-4">
					<div class="flex flex-wrap justify-center">
                        ...
                        for="">Name</label><input type="text" name="" id="" class="border-0 px-3 py-3 rounded text-sm shadow w-full
                    ...
                    bg-gray-300 placeholder-black text-gray-800 outline-none focus:bg-gray-400" placeholder=" "
                        ...
                        type="button" wire:click="save()" style="transition: all 0.15s ease 0s;">Submit
                      </button>
											</div>
										</div>
								</div>

<?php
    ...
    class AddCollegeDetails extends Component
    {
        ...
        public function editCollege($id)
        {
            ...
            $this->college_name= $singleData->college_name;
            $this->address= $singleData->address;
            $this->seats_bba= $singleData->seats_bba;
            $this->seats_bca= $singleData->seats_bca;
            $this->seats_bbm= $singleData->seats_bbm;
            $this->seats_bim= $singleData->seats_bim;
            $this->description=$singleData->description;
            $this->images=$singleData->images;
            $this->hiddenId=$singleData->id;
        }
      
        public function addCollegeDetails()
        {
            $this->college_name = "";
            $this->hiddenId = null;
            $this->address = "";
        ...
        public function render()
        {
            ...
            return view('livewire.admin.add-college-details',['collegeDetails'=>$collegeDetails]);
        }
    }

<div>
    <!-- component -->
    <section>
        <img src="{{ asset('img/form.PNG') }}" alt="pic">
    </section>



    <section class="px-10 lg:px-0">
        <h1 class="text-3xl pb-4 font-mono text-red-800">Feed Back Form</h1>

        <div class=" w-6/12  p-10 rounded-lg ">
            <div class="flex flex-col lg:flex-row gap-5">
                <div>
                    <input type="text" class="border-2 border-red-700 " placeholder="Name" wire:model="name">
                </div>
                <div>
                    <input type="email" class="border-red-700 border-2" placeholder="Email" wire:model="email">

                </div>
            </div>

            <div class=" pt-3 ">
                <textarea  class="border-red-700 lg:px-28  px-10 border-2" rows="8" wire:model="comment"
                    placeholder="Write some message"></textarea>
                <button type="submit" wire:click="save()"
                    class="block w-full  lg:w-8/12 py-2.5 bg-yellow-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-yellow-600 hover:shadow-lg focus:bg-yellow-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-700 active:shadow-lg transition duration-150 ease-in-out">Send
                </button>
    ...
    {{-- <div>
        ...
        <textarea  cols="30" rows="10" wire:model="comment"></textarea>

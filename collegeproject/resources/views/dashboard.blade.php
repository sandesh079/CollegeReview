<x-app-layout>
    ...
    {{-- <img src="{{ asset('img/banner.PNG') }}" alt="pic"> --}}

  

    <div class="grid grid-cols-3 gap-4 px-5 items-center py-5">
        <div class="mb-4">
          <img src="{{ asset('img/plane.jpg') }}" class="max-w-full h-auto rounded-lg" alt="">
        </div>
      
        <div class="mb-4">
          <img src="https://mdbootstrap.com/img/new/standard/city/043.jpg" class="max-w-full h-auto rounded-full" alt="">
        </div>
        <div class="mb-4">
